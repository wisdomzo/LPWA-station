...
class SimpleMesh:
    ...
    def _handle_mesh_message(self, message, source_addr, rssi):
        ...
        # 🆕 Stage 2.2 第1步：添加ROUTE_UPDATE处理
    ...
    def _handle_route_update(self, sender_id, message, rssi):
        ...
        try:
            ...
            for dest_node, route_info in received_routes.items():
                ...
                # 传递跳数参数
                reported_hops = route_info.get('hop_count', 1)
                ...
                # 提取邻居报告的信息
                reported_metric = route_info.get('metric', 0.5)
                reported_seq = route_info.get('seq', 0)
